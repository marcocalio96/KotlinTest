...
import kotlinx.android.synthetic.main.sum_layout.*
import kotlinx.android.synthetic.main.sum_layout.view.*
...
class sumFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var view =  inflater!!.inflate(R.layout.sum_layout, container, false)
        ...
        view.sommabtn.setOnClickListener(View.OnClickListener {
